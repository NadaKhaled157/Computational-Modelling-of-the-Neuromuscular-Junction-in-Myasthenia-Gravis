...
figure
hold on;
plot(t, Flux*6.022e23, 'b');
plot(t, 0.8*Flux*6.022e23, 'r');
hold off;
xlabel('Time (seconds)');
ylabel('Bound Receptor Surface Concentration (molecules/µm^2)');
title('ACh Bound at Post-Synaptic Membrane');
legend({'Normal Physiology', 'Myasthenia Gravis'},'Location','best');
...
beta=4.77e22; %µm^3/mol*s Receptor binding rate
%dCdX=0 at x=0
pl = 0;
ql = 1;
